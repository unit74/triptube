                ...
                <v-dialog v-model="dialogDelete" persistent max-width="500px">
                  <v-card>
                        ...
                        <v-card class="card" tile flat>
                          <v-row no-gutters>
                            <v-col cols="3" sm="2" md="5" lg="5">
                              <v-img class="align-center" :src="`${url}/uploads/thumbnails/${itemToDelete.thumbnailUrl}`"> </v-img>
                            </v-col>
                            <v-col>
                              <div class="ml-2">
                    ...
                    <v-card-actions>
                      ...
                      <v-btn :loading="deleteBtnLoading" color="blue darken-1" text @click="deleteItem">Delete Forever</v-btn>
                    </v-card-actions>
                  </v-card>
                </v-dialog>
              </template>
